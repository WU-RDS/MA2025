...
reqPackages <- c(reqPackages, "formatR")
...
mytable = data.frame(
    ...
    Topics = c("Introduction to the course <br>Basic concepts", 
               ...
               "Introduction to inferential statistics <br>Hypothesis testing I",
...
mytable_sub_1 = data.frame(
    Assignment = c("Assignment 1: R Basics", 
             ...
             "Assignment 4: Causal Modeling & Mediation Analysis (Regression III)"
             ),
    Assigned = c(
      "Oct. 7",
      "Oct. 14",
    ...
    Coaching = c("Oct. 11, 02:00PM-04:00PM (online)*", 
                 "Oct. 18, 04:00PM-06:00PM (online)*",
                 "Nov. 8, 02:00PM-04:00PM (online)*",
                 "Nov. 22, 03:00PM-05:00PM (online)*"
             ),
    Submission = c(
      "Oct. 13, 11:59PM",
      "Oct. 27, 11:59PM",
...
mytable_sub_1 %>% kable(escape = F,  col.names = gsub("[_]", " ", names(mytable_sub_1))) %>%
  kable_paper(c("hover"), full_width = F) %>%
  footnote(general = "Dates and times are indicated for group A. 
           Dates indicated with '*' are optional time slots for individual online video coaching sessions with Elizaveta.
           If you need to schedule a meeting, please contact Elizaveta at least one day in advance (elizaveta.patrikeeva@wu.ac.at).",
           general_title = "Note: ", 
           footnote_as_chunk = T, title_format = c("italic")
           ) 
...
mytable_sub_1 = data.frame(
    ...
    Coaching = c("Oct. 11, 04:00PM-06:00PM (online)*", 
                 "Oct. 25, 02:00PM-04:00PM (online)*",
                 "Nov. 8, 04:00PM-06:00PM (online)*",
                 "Nov. 22, 05:00PM-07:00PM (online)*"
             ),
    Submission = c(
      "Oct. 15, 11:59PM",
      "Oct. 29, 11:59PM",
...
mytable_sub = data.frame(
    Component = c(
             "Intro to Questionnaire design", 
             "Questionnaire coaching*",
             "Data analysis coaching",
             "(Pre-recorded) presentation submission"
             ),
    Date = c(
      "Nov. 18, 01:00PM - 05:00PM",
      "Nov. 25, 01:00PM - 05:00PM",
      "Dec. 09, 01:00PM - 05:00PM",
      "Jan. 5, 11:59PM"
    ),
    Room = c(
      "D5.1.001",
...
mytable_sub %>% kable(escape = T,  col.names = gsub("[_]", " ", names(mytable_sub))) %>%
  kable_paper(c("hover"), full_width = F) %>%
  footnote(general = "Dates and times are indicated for group A.
           Sessions indicated with '*' are group coaching sessions. Slots of 30 min. are assigned to each group within the indicated times.",
           general_title = "Note: ", 
           footnote_as_chunk = T, title_format = c("italic")
           ) 
#%>%   row_spec(c(1,3,6), background = "#E0E0E0")
...
mytable_sub = data.frame(
    ...
    Date = c(
      "Nov. 20, 12:30PM - 04:30PM",
      "Nov. 27, 02:00PM - 06:00PM",
      "Dec. 13, 01:00PM - 05:00PM",
      "Jan. 5, 11:59PM"
    ),
    Room = c(
      "D4.0.022",
