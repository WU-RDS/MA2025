...
# https://wu-rds.github.io/MA2025/summarizing-data.html#data-visualization
...
## ------------------------------------------------------------------------
req_packages <- c("Hmisc", "knitr", "ggplot2", "plyr", "ggthemes", "gtools", "Rmisc", "tidyr", "jsonlite", "dplyr", "ggExtra", "scales", "devtools", "tidyr", "gridExtra", "ggstatsplot", "colorspace")
...
# Grouped plot of means with two grouping variables
